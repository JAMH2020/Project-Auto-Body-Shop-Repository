...
$_SESSION['odometer_intake'] = $_SESSION['school_name'] = $_SESSION['school_address'] = $_SESSION['status'] = $_SESSION['customer_firstname'] = $_SESSION['customer_lastname'] =
$_SESSION['customer_phone'] = $_SESSION['customer_address'] = $_SESSION['customer_email'] = $_SESSION['car_year'] = $_SESSION['car_make'] = $_SESSION['car_model'] = 
