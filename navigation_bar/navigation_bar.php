...
<link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
    ...
    <div class="nav" id="stickyNavX">
      ...
      <a  class= "left_nav_link" href="http://www.portcreditautobodyshop.tk">
      ...
      <a class = "nav_link" href="http://www.portcreditautobodyshop.tk/create_account/signup.php">
        <div class="nav_link_underline"></div>
        Sign-Up
        <div class="nav_link_underline"></div>
      </a>
      ...
      <a class= "nav_link "href="http://www.portcreditautobodyshop.tk/login/login.php">
        <div class="nav_link_underline"></div>
        Sign-In
        <div class="nav_link_underline"></div>
      </a>
